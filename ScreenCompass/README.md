...
- **System tray integration** - Runs in system tray; close button minimizes to tray (Shift+Click to exit)
...
- **Start minimized** - Launch with `-m` or `/m` to start in the system tray
